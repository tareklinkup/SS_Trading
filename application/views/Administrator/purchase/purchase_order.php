                        ...
                        <div class="col-sm-6">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" v-model="selectedProduct.brand_name" readonly
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="sellingPrice" name="sellingPrice" class="form-control"
                                            v-model="selectedProduct.Product_Actual_Sales_Rate" />
                                    </div>
                                </div>
...
new Vue({
    ...
    methods: {
        ...
        productTotal() {
            ...
            if (this.selectedProduct.purchasePrice == undefined) {
                this.selectedProduct.purchasePrice = this.selectedProduct.Product_Actual_Purchase_Rate;
            }
        ...
        addToCart() {
            ...
            let product = {
                ...
                actualPurchaseRate: this.selectedProduct.purchasePrice,
                purchase_percent: this.selectedProduct.purchase_percent,
            ...
            axios.post('/get_purchases', {
                ...
                r.purchaseDetails.forEach(product => {
                    let cartProduct = {
                        ...
                        actualPurchaseRate: product.actualPurchaseRate,
